...
from opentelemetry.sdk.logs import LoggingHandler, LoggerProvider, set_logger_provider
...
otel_logger.addHandler(LoggingHandler(level=logging.NOTSET, logger_provider=logger_provider))
...
@app.route("/0/")
def generate_trace_metrics_logs():
